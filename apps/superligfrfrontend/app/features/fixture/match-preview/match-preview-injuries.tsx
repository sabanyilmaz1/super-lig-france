  ...
  const TeamInjuries = ({
    ...
    <div className="space-y-2">
      ...
      <div className="grid gap-2">
        ...
        {injuries.length === 0 && (
          <p className="text-xs text-gray-500">No injuries reported</p>
        )}
      </div>
    </div>
  );
  ...
  return (
    <TabsContent value="injuries">
      ...
      <div className="hidden sm:grid sm:grid-cols-2 gap-4">
        <TeamInjuries title="Home Team" injuries={homeInjuries} />
        <TeamInjuries title="Away Team" injuries={awayInjuries} />
      </div>
